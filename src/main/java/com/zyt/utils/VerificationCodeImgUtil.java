...
public class VerificationCodeImgUtil {
    ...
    // 验证码范围
    private char[] codeSequence = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'O','P', 'Q', 'R',
            'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z','a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'm', 'n', 'o','p', 'q', 'r',
    ...
    public String getCode() {
     ...
     public static void main(String[] args) {
           VerificationCodeImgUtil verificationCodeImgUtil  = new VerificationCodeImgUtil(160,40,5,500);
         try {
             String path = "D:/" + System.currentTimeMillis() + ".jpg";
             System.out.println(verificationCodeImgUtil.getCode() + " >" + path);
             verificationCodeImgUtil.write(path);
         } catch (IOException e) {
             e.printStackTrace();
         }
     }
