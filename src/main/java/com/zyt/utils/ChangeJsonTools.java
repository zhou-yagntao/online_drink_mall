...
/**
 * @ProjectName: springboot_redis
 * @Package: com.chinaedu.util
 * @ClassName: ChangeJsonTools
 * @Author: Justin
 * @Description:
 * @Date: 13:43 2020/5/20
 * @Version: 1.0
 */
public class ChangeJsonTools {
    private static final Logger log = LoggerFactory.getLogger(com.zyt.utils.ChangeJsonTools.class);
